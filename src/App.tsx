...
// Shuffle determinístico y pick del día
const seededPickDaily = (dayIndex: number): Character => {
  ...
  // Fisher–Yates shuffle (determinístico con rand())
...
const getSecretForDay = (dayIndex: number): Character => {
  const scheduledId = DAILY_SCHEDULE[dayIndex] // dayIndex 0 = Día 1
  if (scheduledId) {
...
// ---------- Partida diaria en localStorage ----------
...
// ---------- Texto para compartir resultado ----------
...
function App() {
  // Modo preview por query param: ?preview=1
  ...
  return (
    <div className="otakudle-container">
      ...
      <p className="intro-text">
        Todos tienen el mismo personaje y cambia cada 24 horas. Usa las pistas para acercarte.
      </p>
